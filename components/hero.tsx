    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-16 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        <div className={`transition-all duration-1000 ${isVisible ? "opacity-100" : "opacity-0"}`}>
          ...
          <p className="text-primary font-semibold mb-4 tracking-widest uppercase text-sm">Welcome Boss</p>
          ...
          <p className="text-lg md:text-xl text-foreground/70 max-w-2xl mx-auto mb-8 leading-relaxed font-light">
            I craft stunning digital experiences that turn ideas into impact. Let's build something extraordinary.
          </p>
