...
export const experiences: Experience[] = [
  {
    id: 1,
    title: "Fullstack Developer – Subtop App",
    company: "Odos Africa",
    period: "2025 (Ongoing)",
    description: "Developed the Subtop VTU app, a full-stack React Native and Node.js project. Built backend services for transactions, user authentication, and real-time updates, while ensuring responsive and seamless frontend experiences. Integrated eBills.africa APIs for mobile top-ups and utility payments. Collaborated on feature design, testing, and optimization to enhance user engagement and system reliability.",
    skills: ["React Native", "Node.js", "Fullstack Development", "API Integration", "VTU Services", "Mobile Payments", "Real-time Updates"],
  },
  {
    id: 2,
    title: "Mobile Frontend Developer – Grearn App",
    company: "Odos Africa",
    period: "2025",
    description: "Developed the mobile frontend of the Grearn agricultural trading platform using React Native. Implemented interactive UI components for users to invest in foodstuffs and track their investments. Worked closely with backend developers to integrate APIs and ensure smooth user experiences on Android and iOS devices.",
    skills: ["React Native", "Mobile Frontend", "UI Development", "API Integration", "Cross-Platform", "Agritech App"],
  },
  {
    id: 3,
    title: "Frontend Developer – Speedax Web App",
    company: "Gandaria Ventures",
    period: "2025",
    description: "Worked on the frontend of the Speedax fintech web app using Next.js. Implemented interfaces for sending and depositing funds, VTU services, and cryptocurrency transactions. Ensured responsive design, usability, and performance across devices while collaborating with backend developers to integrate endpoints.",
    skills: ["Next.js", "Frontend Development", "Fintech", "Responsive Design", "API Integration", "Crypto & Payments"],
  },
  {
    id: 4,
    title: "Web Developer – Riverstone Real Estate App",
    company: "Maitech",
    period: "2025",
    description: "Onboarded as an on-demand software engineer to expand features and integrate new endpoints into the Riverstone real estate management system. Implemented backend enhancements, feature updates, and performance optimizations while ensuring compatibility with existing workflows and multi-user access.",
    skills: ["Backend Development", "Feature Integration", "API Development", "Real Estate Tech", "Performance Optimization", "Multi-user Systems"],
  },
  {
    id: 5,
    title: "WordPress Developer & Plugin Specialist – NaijaTask",
    company: "Titho Foundation",
    period: "2024–2025",
    description: "Expanded features and built custom WordPress plugins for the NaijaTask platform. Delivered tailored solutions to enhance the website's functionality and usability. Provided technical support, ongoing updates, and optimization for performance and user experience.",
    skills: ["WordPress Development", "Custom Plugins", "Feature Expansion", "Website Optimization", "Technical Support"],
  },
  {
    id: 6,
    title: "Mobile App Developer – Evidence Loop",
    company: "Private Contractor (Confidential)",
    period: "2024–2025",
    description: "Developed a confidential AI research assistant mobile application. Implemented mobile interfaces, integrated backend services, and ensured secure, efficient performance for end-users. Collaborated with stakeholders on feature planning, iterative development, and testing.",
    skills: ["Mobile Development", "AI Integration", "Frontend Development", "Backend Collaboration", "Secure App Design"],
  },
  {
    id: 7,
    title: "Fullstack Developer – Blass eLibrary",
    company: "Blass College",
    period: "2025",
    description: "Built a multi-user full-stack web application for Blass College, allowing library uploads, searches, and resource access. Developed both frontend and backend components, implemented user authentication, and ensured seamless multi-user interactions and responsive design across devices.",
    skills: ["Fullstack Development", "Multi-user Systems", "Web App Development", "Search & Upload Features", "Frontend & Backend", "Responsive Design"],
  },
  {
    id: 8,
